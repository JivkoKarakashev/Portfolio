...
type IconName = 'github' | 'angular' | 'rxjs' | 'typescript' | 'html' | 'css' | 'fontawesome' | 'firebase' | 'google-cloud' | 'cloudflare' | 'git' | 'vs-code' | 'eslint' | 'react' | 'javascript' | 'nodejs' | 'expressjs' | 'mongodb' | 'mongoosejs' | 'handlebars' | 'json-web-tokens' | 'nodemon' | 'lit-html' | 'playwright';
